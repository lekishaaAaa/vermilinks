const SENSOR_FIELD_CONFIG = [
  ...
  { key: 'ambientHumidity', label: 'Ambient Humidity', unit: '%' },
  { key: 'binTemperature', label: 'Bin Temperature', unit: '°C' },
  { key: 'binHumidity', label: 'Bin Humidity', unit: '%' },
  { key: 'moisture', label: 'Soil Moisture', unit: '%' },
  { key: 'soilMoistureLayer1', label: 'Soil Moisture L1', unit: '%' },
  { key: 'soilMoistureLayer2', label: 'Soil Moisture L2', unit: '%' },
  { key: 'soilMoistureLayer3', label: 'Soil Moisture L3', unit: '%' },
  { key: 'soilTemperature', label: 'Soil Temperature', unit: '°C' },
  { key: 'soilTemperatureLayer1', label: 'Soil Temperature L1', unit: '°C' },
  { key: 'soilTemperatureLayer2', label: 'Soil Temperature L2', unit: '°C' },
  { key: 'soilTemperatureLayer3', label: 'Soil Temperature L3', unit: '°C' },
